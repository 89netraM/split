...
namespace Split.Infrastructure.Repositories.Migrations
{
    ...
    [Migration("20260108054654_AddAlternateUserIds")]
    partial class AddAlternateUserIds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Split.Domain.User.UserAggregate", b =>
                {
                    b.OwnsMany("Split.Domain.Primitives.AlternateUserId", "AlternateIds", b1 =>
                        {
                            ...
                            b1.HasIndex("UserAggregateId", "Type")
                                .IsUnique();

                            b1.ToTable("AlternateUserId");
