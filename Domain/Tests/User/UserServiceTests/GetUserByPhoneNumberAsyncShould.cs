...
[TestClass]
public class GetUserByPhoneNumberAsyncShould
{
    [TestMethod]
    public async Task ReturnUser_WhenUserExists()
    {
        ...
        // Act
        var result = await userService.GetUserByPhoneNumberAsync(user.PhoneNumber, CancellationToken.None);
    ...
    public async Task ReturnNull_WhenUserDoesNotExist()
    {
        ...
        // Act
        var result = await userService.GetUserByPhoneNumberAsync(userPhoneNumber, CancellationToken.None);
